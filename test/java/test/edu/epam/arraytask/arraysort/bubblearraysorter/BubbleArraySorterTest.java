package test.edu.epam.arraytask.arraysort.bubblearraysorter;

import edu.epam.arraytask.sort.ArraySorter;
import edu.epam.arraytask.sort.impl.BubbleArraySorter;
...
public class BubbleArraySorterTest {
    ...
    public void testSort() {
        ...
        ArraySorter arraySorter = new BubbleArraySorter();
